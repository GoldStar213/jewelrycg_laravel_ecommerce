            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 1.0em; text-align: left;">
            			<div class="text">
            				<h2>Hey {{ $conversationUser->first_name }},</h2>
            				<h3>This is just a quick email to let you know you've received messages from {{ $senderUser->username }}.</h3>
							@foreach ($messages as $message)
								<p>{{ $message }}</p>
								<hr style="border-width: 0; background: #eeeeee; color: #eeeeee; height:1px">
							@endforeach
            			</div>
            		</td>
            	</tr>
	      	...
	      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  	<td valign="middle" colspan="5"style="text-align:center; padding: 1em 1.0em;">
							<p><a href="{{ route('index') }}/chat/{{ $senderUser->username }}" class="btn btn-primary">View and Reply</a></p>
					  	</td>
					</tr>
	      	</table>
	      </tr><!-- end tr -->
