        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mx-auto hero-content-container">
                    <h4 class="fs-16 pb-4 mb-0">The world's preferred source for Jewelry CG models</h4>
                    <h1 class="font-weight-bold pb-4 mb-0">Explore our vast collections of Jewelry 3D models</h1>
                </div>    
                <div class="hero-categories filter-categories dnone">
                    ...
                    <div class="search-form ml-auto mr-auto">
                        <form method="get" action="{{ route('search') }}">
                            <div class="search-col">
                                ...
                                <input name="q" type="search" placeholder="Search Ex. cuban ring" aria-label="Search"
