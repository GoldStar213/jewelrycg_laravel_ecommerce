...
@if (count($arrProductMaterials))
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="alert alert-secondary" role="alert"><strong>Step {{ $step }}:</strong> Select the metal below that you will use to make this item.</div>
            <div id="">
            ...
            <div class="alert alert-secondary" role="alert"><strong>Step {{ $step }}:</strong> Please choose the type of diamonds you will utilize.</div>
            <div>
                <div class="accordion-body">
                    <div class="row">
