            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 1.0em; text-align: left;">
            			<div class="text">
            				<h3>Hey {{$first_name}}, Your order has been placed.</h3>
            				<h4>For reference your order number is #{{$orderID}}</h4>
            			</div>
            		</td>
            	</tr>
            </table>
	      ...
	      <tr>
	      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  	...
					  	<td valign="middle" width="20%" style="text-align:right; padding: 0 1.0em;padding-left:0;">
					  		<span class="price" style="color: #000; font-size: 16px;">${{$service_fee}}</span>
					  	</td>
					</tr>
					<tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  	<td valign="middle" width="80%" style="text-align:left; padding: 0 1.0em;">
