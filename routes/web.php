...
use App\Http\Controllers\ExtendServiceDeliveryController;
...
// Backend
Route::group(['prefix' => 'backend', 'as' => 'backend.', 'middleware' => ['auth', 'admin', 'redirectIfDeactivated']], function () {
...
// Homepage
Route::get('/', [AppController::class, 'index'])->middleware('redirectIfDeactivated')->name('index');

// Seller Profile
Route::get('/u/{username}', [SellerController::class, 'seller_profile'])->middleware('redirectIfDeactivated')->name('seller_profile');

Route::group(['middleware' => ['auth', 'user.activity', 'redirectIfDeactivated']], function () {
    // User Dashboard
...
//services
Route::group(['prefix' => 'services', 'as' => 'services.', 'middleware' => ['redirectIfDeactivated']], function () {
    ...
    Route::get('/checkout/payment/{id}/{custom}', [ServicesController::class, 'get_payment'])->name('payment.get');
    ...
    Route::get('/checkout/custom/{id}/{custom}', [ServicesController::class, 'get_billing'])->name('billing.get');
    ...
    Route::post('/message', [ServicesController::class, 'message'])->name('message');
    Route::post('/messageCheckExisted', [ServicesController::class, 'message_check_existed'])->name('messageCheckExisted');
    Route::post('/createCustomPackage', [ServicesController::class, 'create_custom_package'])->name('createCustomPackage');
    Route::post('/updateCustomPackage', [ServicesController::class, 'update_custom_package'])->name('updateCustomPackage');
    Route::post('/extend-service-delivery', [ExtendServiceDeliveryController::class, 'extendDelivery'])->name('extend-service-delivery');
    Route::post('/extend-service-delivery/answer-request', [ExtendServiceDeliveryController::class, 'answerRequest'])->name('answer-request');
});

// Seller Dashboard
Route::group(['middleware' => ['auth', 'user.activity', 'redirectIfDeactivated'], 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::get('/payment/details', [SellerController::class, 'payment_details'])->name('payment.details');
    Route::post('/payment/details', [SellerController::class, 'save_payment_details'])->name('payment.details.post');
...
Route::get('/image/{filename}', [AppController::class, 'image'])->middleware('redirectIfDeactivated');
...
// Products
Route::middleware(['auth', 'admin', 'user.activity'])->resource('products', ProductController::class)->except(['index', 'show']);
...
Route::group(['controller' => CourseController::class, 'prefix' => 'courses', 'as' => 'courses.'], function () {
    Route::middleware(['auth', 'user.activity', 'redirectIfDeactivated'])->group(function () {
...
Route::group(['controller' => CartController::class], function () {
    ...
    Route::post('/chat/file_information',[ChatController::class, 'getChatInFormationBy'])->name('chat.file_information');
    Route::post('/chat/offer_information',[ChatController::class, 'getOfferInFormationBy'])->name('chat.offer_information');
    Route::post('/chat/con_information',[ChatController::class, 'getConInFormationBy'])->name('chat.con_information');
    Route::post('/chat/message_delete',[ChatController::class, 'message_delete'])->name('chat.message_delete');
    Route::post('/chat/chat_archive',[ChatController::class, 'chat_archive'])->name('chat.chat_archive');
    Route::post('/chat/chat_delete',[ChatController::class, 'chat_delete'])->name('chat.chat_delete');
    Route::post('/chat/check_status',[ChatController::class, 'check_status'])->name('chat.check_status');
    Route::post('/chat/block_user',[ChatController::class, 'block_user'])->name('chat.block_user');
    Route::post('/chat/search_user',[ChatController::class, 'search_user'])->name('chat.search_user');
    });
});
