<x-app-layout :page-title="'Order #' . $order->course_id">
          ...
          <div class="order-items-card border-bottom py-4 mb-5">
              <div class="row">
                  ...
                  <div class="col-lg-3 col-6 mb-2">
                      ...
                      <div class="fs-14 ">
                          {{ ucwords(Config::get('constants.order_payment_status')[$order->status_payment]) }}</div>
                  </div>
                  <div class="col-lg-3 col-6 mb-2">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-10 col-9">
                      ...
                      <div class="is_downloadable fw-600 fs-16">
                            ...
                            <a class="btn btn-primary" href="/courses/take/{{$order->course->slug}}">Take Course</a>
                            @endif
                          @php
