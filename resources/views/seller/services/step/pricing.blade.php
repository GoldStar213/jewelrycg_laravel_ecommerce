...
<form action="{{ route('seller.services.package') }}" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-xl-6 col-lg-8 mx-auto">
            @csrf
            <div class="card">
                <div class="card-header">Custom Pricing Only</div>
                <div class="card-body">
                    <p>While fixed packages can be beneficial, some tasks are intricate and vary greatly, making upfront pricing challenging. By enabling this feature, you necessitate a prior conversation with your clients. This allows you to fully grasp their requirements and devise a tailor-made package that fits their needs perfectly. It's a useful approach to ensure both accurate pricing and customer satisfaction.</p>
                    <div>
                        <div class="fw-600 mb-1">Custom Pricing Only?</div>
                        <input type="radio" id="yes" name="option_custompricing" value="1" {{ $loadOptionCustomPricing == 1 ? 'checked' : '' }}>
                        <label for="yes">Yes</label>
                        <input type="radio" id="no" name="option_custompricing" value="0" {{ $loadOptionCustomPricing != 1 ? 'checked' : '' }}>
            ...
            <div class="card package-content">
                <div class="card-header">
                    ...
                    <div class="">
                        Offer Packages: <input data-id="" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{count($packages) >= 3 ? "checked": ""}}>
                    </div>
                </div>
...
<script>
  $(function() {
    ...
    {!! $loadOptionCustomPricing == 1 ? "$('.package-content').css('display', 'none')" : "" !!}

    $('input[name="option_custompricing"]').change(function() {
        if ($(this).val() == '1') $('.package-content').css('display', 'none')
        else $('.package-content').css('display', 'block')
    })
  })
  function setofferpk() {
