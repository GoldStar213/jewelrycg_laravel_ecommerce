        ...
        try
        {
            ...
            if (!$order) {
                ...
                foreach ($cartItems as $item) {
                    ...
                    $orderItem->status_fulfillment = 1;
                    $orderItem->product_digital_download_assets = $item->model->digital_download_assets;

                    if ($item->model->digital_download_assets !== null && $item->model->digital_download_assets !== 0) {
                    ...
                    if (isset($item->options['id'])) {
                        ...
                        if ($orderItem->product_digital_download_assets !== null && $orderItem->product_digital_download_assets !== 0) {
                            $orderItem->status_fulfillment = 3;
                        }
