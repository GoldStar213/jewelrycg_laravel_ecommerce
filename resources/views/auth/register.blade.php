<x-app-layout>
    <x-auth-card>
        ...
        <div class="mt-3 d-flex justify-content-around">
            <a href="{{route('login.google')}}" class="d-flex align-items-center login-link">
                <img src="/assets/img/google-login.svg" class="login-svg w-50px"/>
                <p>Google</p>
            </a>
            <a href="{{route('login.apple')}}" class="d-flex align-items-center login-link d-none">
                <img src="/assets/img/apple-login.svg" class="login-svg "/>
                <p>Apple</p>
            </a>
        </div>
