<x-app-layout page-title="Blog | Jewelry CG">
<section class="border-bottom pt-9 pb-5 mb-6">
    ...
    <section class="bg-white pb-4">
        <div class="container">
            <div class="col-lg-12">
                <div class="row gutters-10 row-cols-lg-4 row-cols-md-2 row-cols-1">
                    ...
                    <div class="col mb-3">
                        <div class="blog-post-list-container">
                            <a href="{{ route('blog.post.url', ['slug'=>$post->slug]) }}" class="text-reset d-block">
                                ...
                                @else
                                    <img src="{{$post->uploads->getImageOptimizedFullName(600,400)}}" alt="{{ $post->name }}" class="img-blog-cropped rounded border lazyloaded">
                                @endif
                            </a>
                            <div class="p-2 pt-3">
