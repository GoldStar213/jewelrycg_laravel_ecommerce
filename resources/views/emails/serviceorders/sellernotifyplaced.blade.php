            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 1.0em; text-align: left;">
            			<div class="text">
            				<h3>Hey {{$first_name}}, You received a new order!</h3>
            				<h4>For reference the order number is #{{$orderID}}</h4>
            			</div>
            		</td>
            	</tr>
            </table>
                    ...
                    <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  	<td valign="middle" width="80%" style="text-align:left; padding: 0 1.0em;">
					  		<div class="product-entry" style="width:100%">
                                <a href="{{route('services.order_detail', $orderID)}}">
                                    <div class="text">
                                        <h3>{{$service_name}}</h3>
					  	...
					  	<td valign="middle" width="20%" style="text-align:right; padding: 0 1.0em;padding-left:0;">
					  		<span class="price" style="color: #000; font-size: 16px;">${{$package_price}}</span>
					  	</td>
					</tr>
					<!-- end service details-->
					<tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
					  	<td valign="middle" colspan="5"style="text-align:center; padding: 1em 1.0em;">
					  		<p><a href="{{route('seller.service.order.detail', $orderID)}}" class="btn btn-primary">View or manage order</a></p>
					  	</td>
					</tr>
					<!-- totals & taxes-->
	      	</table>
