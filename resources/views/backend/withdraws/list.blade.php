		...
		<div id="datatable_wrapper" class="border dataTables_wrapper no-footer">
          ...
          @foreach ($withdraws as $withdraw)
            <tr role="row" class="odd">
              ...
              <td>
                <div class="dropdown">
                  <button class="btn btn-sm btn-primary dropdown-toggle" type="button" id="dropdownMenuButton_{{$withdraw->id}}" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton_{{$withdraw->id}}">
                    ...
                    <li><a href="{{ route('backend.withdraws.status.finished', $withdraw->id) }}" class="dropdown-item" href="#">Finished/Paid</a></li>
