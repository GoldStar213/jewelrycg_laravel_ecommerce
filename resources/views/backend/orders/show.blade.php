                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6 mb-2">
                        ...
                        <div class="fs-14" title="{{ $order->status_payment_reason }}">
                            {{ ucwords(Config::get('constants.order_payment_status')[$order->status_payment]) }}
                        </div>
                    </div>
                    <div class="col-lg-3 col-6 mb-2">
                            ...
                            if ($order->status_payment == 2) {
                                ...
                                foreach ($order->items as $key => $item) {
                                    if ($item->status_fulfillment == '1') {
                                        $status = 'Unfulfilled';
                                        // Break the loop if you only need to check one unfulfilled item
                                        break;
                                    }
                                }
                                echo $status;
                            } else {
                                echo 'Unpaid/Payment Issue';
                            }
                            @endphp
                        </div>
                    </div>
                            ...
                            <div class="is_downloadable mt-2" data-item-id="{{ $item->id }}"
                                ...
                                <div class="mt-2">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <input
                                                class='track_number @if ($item->status_fulfillment != 2) d-none @endif form-control w-100'
                                                type='text' placeholder='Tracking Number' name='track_number'
