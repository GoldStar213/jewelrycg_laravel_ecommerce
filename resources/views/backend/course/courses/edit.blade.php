        ...
        <div class="col-md-8">
            <div class="card col-md-12 mb-4">
                ...
                <div class="card-body row">
                    ...
                    <div class="mb-4">
                        <label class="mb-2 w-100" for="status">Status:</label>
                        <select class="selectpicker" name="status">
                            <option value="0" @if($course->status == 0) selected @endif>Draft</option>
                            <option value="1" @if($course->status == 1) selected @endif>Published</option>
                        </select>
                    </div>
                    <div class="mb-4">
