@extends('backend.layouts.app', ['activePage' => 'orders', 'title' => 'Pending Orders', 'navName' => 'ordersPending', 'activeButton' => 'catalogue'])

@section('content')
<div class="page-header">
    <div class="row align-items-end">
        <h1 class="page-header-title">Pending Orders</h1>
    </div>
    <!-- End Row -->
</div>  
            ...
            <tbody>
                @foreach ($orders as $order)
                    <tr>
                        ...
                        <td>${{ number_format($order->grand_total / 100, 2) }}</td>
                        ...
                        <td title="{{ $order->status_payment_reason }}">
                            {{Config::get('constants.order_payment_status')[$order->status_payment]}}
                        </td>
                        <td>
                            @php
                              $status = 'Fulfilled';
