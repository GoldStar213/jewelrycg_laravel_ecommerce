...
class ProductController extends Controller
{
    ...
    public function show($slug, Request $request)
    {
        ...
        // Retrieve the related products based on the main product's category
        ...
        foreach($productTags as $productTag) {
            foreach($product->tags as $hadProductTag) {
                if ($productTag->id == $hadProductTag->id_tag) {
                    array_push($tags, $productTag->name);
                }
            }
        }
        ...
        */
        ...
        return view('products.show', compact(
        'product', 'uploads', 'variants', 'maxPrice', 'minPrice',
        'relatedProducts', 'product_reviewable', 'user_product_review', 'review_count',
        'average_rating', 'arrReviewListing', 'arrProductMaterials', 'arrProductDiamonds', 'purchaseInfo', 'attributes', 'tags'
        ));
    }
