                            ...
                            <div class="mb-4 col-lg-4">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('products.show', $product->slug) }}">
                                      <img src="{{ $product->uploads->getImageOptimizedFullName(600,400) }}" alt="{{ $product->name }}" class="border w-100 mb-3 img-fluid">
                                    </a>
                                    <h5>{{ $product->name }}</h5>
                                    <!--
                    ...
                    @if ($service->status === 1)
                        ...
                        <div class="card">
                            ...
                            <a href="/services/{{$service->slug}}">
                              <img src="{{ $service->uploads->getImageOptimizedFullName(600,400) }}" alt="{{ $service->name }}" class="border w-100 mb-3 img-fluid">
                            </a>
                            <h5>{{ $service->name }}</h5>
                            <!--
